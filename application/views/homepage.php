...
?>
    ...
    <!-- HOME SLIDER -->
    <section class="slide" style="background-image: url(<?=base_url()?>assets/images/homeslider/bg.jpg)">
        <div class="container">
    ...
    <section id="mc-section-3" class="mc-section-3 section">
        <div class="container">
            ...
            <div class="feature-course">
                ...
                <a href="<?=base_url()?>home/categories" class="all-course mc-btn btn-style-1">View all</a>
                <div class="row">
