    ...
    <footer id="footer" class="footer">
        ...
        <div class="second-footer">
            <div class="container">
                ...
                <p class="copyright">Copyright © 2020 ElearningByAtul. All rights reserved.</p>
            </div>
        </div>
    </footer>
    <!-- END / FOOTER -->
...
<script type="text/javascript" src="<?=base_url()?>assets/js/library/jquery.owl.carousel.js"></script>
<script type="text/javascript" src="<?=base_url()?>assets/js/library/jquery.appear.min.js"></script>
<script type="text/javascript" src="<?=base_url()?>assets/js/library/perfect-scrollbar.min.js"></script>
<script type="text/javascript" src="<?=base_url()?>assets/js/library/jquery.easing.min.js"></script>
