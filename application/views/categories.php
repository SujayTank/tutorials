...
?>
    ...
    <section class="page-control">
        <div class="container">
            <div class="page-info">
                <a href="<?=base_url()?>home"><i class="icon md-arrow-left"></i>Back to home</a>
            </div>
            <div class="page-view">
                View
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="mc-item mc-item-2">
                                    ...
                                    <div class="content-item">
                                        ...
                                        <h4><a href="<?=base_url()?>home/courseintro">The Complete Digital Photography Course Amazon Top Seller</a></h4>
                ...
                <div class="col-md-3 col-md-pull-9">
                    <aside class="sidebar-categories">
                        <div class="inner">
                            ...
                            <!-- BANNER ADS -->
                            <div class="mc-banner">
                                <a href="#"><img src="<?=base_url()?>assets/images/banner-ads-1.jpg" alt=""></a>
                            </div>
                            <!-- END / BANNER ADS -->
    
                            <!-- BANNER ADS -->
                            <div class="mc-banner">
                                <a href="#"><img src="<?=base_url()?>assets/images/banner-ads-2.jpg" alt=""></a>
                            </div>
                            <!-- END / BANNER ADS -->
                        </div>
                    </aside>
